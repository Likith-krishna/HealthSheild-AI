        ...
        {!forgotPasswordStep ? (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4.5">
              ...
              <div className="space-y-1.5">
                <label className="text-slate-400 text-[11px] font-bold uppercase tracking-wider block">User ID or Email Address</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Enter your User ID or registration email"
            ...
            <div className="mt-6 border-t border-[#131313] pt-5 text-center">
              <p className="text-xs text-slate-500">
                New user profile requesting registration?{" "}
                <button
                  type="button"
          ...
          >
            <div className="mb-6 text-center">
              ...
              <h3 className="text-xl font-extrabold text-white uppercase tracking-tight">Credentials Override</h3>
              <p className="text-xs text-slate-400 mt-1">Change your password instantly using your registered identity</p>
            </div>
            ...
            <form onSubmit={handleForgotTrigger} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-slate-400 text-[11px] font-bold uppercase tracking-wider block">Your User ID or Email ID</label>
                <div className="relative">
                  <User className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-500" />
                  <input
                    type="text"
                    ...
                    placeholder="john_doe or name@organization.com"
              ...
              <div className="space-y-1.5">
                <label className="text-slate-400 text-[11px] font-bold uppercase tracking-wider block">Choose New Password (Alphanumeric)</label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-500" />
                  <input
              ...
              <div className="space-y-1.5">
                <label className="text-slate-400 text-[11px] font-bold uppercase tracking-wider block">Confirm New Password</label>
                <div className="relative">
                  <Lock className="absolute left-3.5 top-3.5 h-4.5 w-4.5 text-slate-500" />
                  <input
                    type={showForgotPass ? "text" : "password"}
              ...
              <button
                ...
                className="w-full text-xs text-slate-500 hover:text-white font-bold transition-colors uppercase outline-none py-1.5"
              >
                Return to Credentials Mode
              </button>
            </form>
          </motion.div>
        )}
