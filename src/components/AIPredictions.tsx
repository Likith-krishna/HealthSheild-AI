  ...
  if (!evaluation) {
    return (
      <div id="ai-predictions-empty" className="bg-[#0F0F0F] border border-[#1A1A1A] rounded-2xl p-8 flex flex-col items-center justify-center text-center space-y-3 min-h-[400px]">
        ...
        <h3 className="text-lg font-medium text-white">No Risk Intel Loaded</h3>
        <p className="text-sm text-slate-500 max-w-sm">
          Modify the baseline vital metrics on the left, then trigger "Simulate Prognosis Prediction Index" to construct your predictive twin profile!
        </p>
      </div>
    );
  }
      ...
      <div className="bg-[#0F0F0F] border border-[#1A1A1A] rounded-2xl p-6 shadow-xl shadow-black/30">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
          ...
          <div className="flex flex-col items-center text-center p-3 border-r border-[#151515] md:col-span-1">
            <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3">Overall Health Score</span>
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-semibold text-slate-300">Resilience Index Indicators</h3>
              <span className="text-xs text-slate-500">Target Range: &gt; 75</span>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div className="p-3 bg-[#050505] border border-[#1A1A1A] rounded-xl">
                <div className="flex justify-between items-center text-xs mb-1">
                  <span className="text-slate-400 font-medium">Cardiovascular Index</span>
              ...
              <div className="p-3 bg-[#050505] border border-[#1A1A1A] rounded-xl">
                <div className="flex justify-between items-center text-xs mb-1">
                  <span className="text-slate-400 font-medium">Metabolic Clearance</span>
              ...
              <div className="p-3 bg-[#050505] border border-[#1A1A1A] rounded-xl">
                <div className="flex justify-between items-center text-xs mb-1">
                  <span className="text-slate-400 font-medium">Lifestyle Resilience</span>
              ...
              <div className="p-3 bg-[#050505] border border-[#1A1A1A] rounded-xl">
                <div className="flex justify-between items-center text-xs mb-1">
                  <span className="text-slate-400 font-medium">Allostatic Stress Balance</span>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="text-base font-semibold text-white flex items-center gap-1.5">
            ...
            Predicted Disease Prognosis Index
          </h2>
          <span className="text-xs text-emerald-400 font-medium font-mono bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">
            {predictions.length} High-Hazard Vectors
          </span>
        </div>
              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-slate-500 font-medium">Relative Probability</span>
                ...
                <div className="grid grid-cols-2 gap-3 text-slate-400 text-[10px] bg-[#0A0A0A] border border-[#1C1C1C] p-2.5 rounded-xl">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span>Accuracy: <strong>{p.confidenceScore}%</strong></span>
                  </div>
                  <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-1.5 col-span-2">
                    ...
                    <span>Progression hazard level: <strong>{p.progressionRisk}%</strong></span>
                  </div>
                </div>
                ...
                {p.triggers && p.triggers.length > 0 && (
                  <div className="space-y-1">
                    <span className="text-[10px] font-bold text-slate-500 uppercase">Underlying Biomarker Triggers:</span>
        ...
        <div className="bg-[#0A0A0A] border border-[#222] text-white rounded-2xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-[#222] pb-4 gap-4">
            <div>
              <h3 className="text-sm font-semibold tracking-widest text-emerald-400 uppercase flex items-center gap-1.5">
                <TrendingUp className="h-4 w-4" /> COMPREHENSIVE DISEASE FORECAST
              </h3>
              <h2 className="text-lg font-bold text-white mt-1">
                Risk Development Curve Over 5 Years
              </h2>
            </div>
          ...
          <div className="mt-5 text-xs text-slate-300 bg-[#0F0F0F] border border-[#1A1A1A] p-3.5 rounded-xl space-y-1.5">
            <span className="font-bold text-emerald-450 flex items-center gap-1">
              <HelpCircle className="h-3.5 w-3.5 text-emerald-400" /> Progression Trajectory Commentary:
            </span>
