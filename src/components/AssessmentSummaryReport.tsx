...
import { 
  ...
  AlertTriangle, Sparkles, Heart, BrainCircuit, RefreshCw, AlertCircle
} from "lucide-react";
  ...
  if (!selectedRecord || !evaluation) {
    return (
      <div className="bg-[#0A0A0A] border border-[#1A1A1A] rounded-2xl p-10 text-center space-y-4">
        ...
        <h3 className="text-sm font-black uppercase text-white tracking-wider">No Active Timeline Data Found</h3>
        <p className="text-xs text-slate-500 max-w-sm mx-auto">
          Please navigate to the "Health Data Input" screen and submit your current biomarkers first to compile your Clinical Summary Report.
        </p>
      </div>
    );
  }
      ...
      <div className="bg-gradient-to-r from-neutral-900 to-neutral-950 border border-[#1E1E1E] rounded-2xl p-4.5 flex gap-4 flex-col sm:flex-row justify-between items-center no-print">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] text-emerald-400 font-extrabold uppercase tracking-widest font-mono">Precision Clinical Record</span>
          </div>
          <h2 className="text-base font-black text-white uppercase tracking-tight">Weekly Assessment Summary Report</h2>
          <p className="text-xs text-slate-500">Generate, print or export a comprehensive summary review of all diagnostic factors.</p>
        </div>
      ...
      >
        ...
        <div className="border-b border-[#1C1C24] pb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 print-border print-text-dark">
          ...
          <div className="font-mono text-left md:text-right text-[10px] space-y-1 text-slate-400 print-text-muted">
            <p><span className="text-slate-550 mr-1.5 font-bold uppercase">Report Ref ID:</span> <span className="text-white font-bold print-text-dark">AGR-{selectedRecord.id?.substring(0, 8).toUpperCase() || "WEEKLY"}</span></p>
            <p><span className="text-slate-550 mr-1.5 font-bold uppercase">Assessment Date:</span> {new Date(selectedRecord.timestamp).toLocaleDateString()} {new Date(selectedRecord.timestamp).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</p>
            <p><span className="text-slate-550 mr-1.5 font-bold uppercase">Print Generation:</span> {new Date().toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="bg-[#050507] border border-[#121216] rounded-xl p-4.5 print-bg-light print-border print-text-dark">
          <span className="text-[9px] text-emerald-450 font-bold uppercase tracking-widest block mb-2 px-1 font-mono">Patient Demographics</span>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs font-medium">
            ...
            <div>
              ...
              <strong className="text-[#E4E4E7] block mt-0.5 print-text-dark">{basicInfo.age || 30} yrs ({basicInfo.gender || "Unspecified"})</strong>
            </div>
            <div>
              <span className="text-[9px] text-[#71717A] uppercase block">Calculated BMI</span>
              <strong className="text-[#E4E4E7] block mt-0.5 print-text-dark">
                {bmiVal} kg/m² <span className="text-[9px] bg-zinc-900 border border-neutral-800 text-slate-400 px-1.5 py-0.5 rounded ml-1 font-mono uppercase print-badge">{bmiCategory}</span>
              </strong>
            </div>
            <div>
              <span className="text-[9px] text-[#71717A] uppercase block">Residence Node</span>
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-black text-[#A1A1AA] uppercase tracking-widest flex items-center gap-1.5">
            <Award className="h-4 w-4 text-emerald-500" /> Multi-Coordinate Diagnostic Scores
          </h3>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-1">
            ...
            {/* Nutrition Index */}
            <div className="bg-[#050507]/65 border border-[#16161C] p-3 rounded-xl text-center print-border print-bg-light">
              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">Nutrition Index</span>
            ...
            {/* Sleep Rest */}
            <div className="bg-[#050507]/65 border border-[#16161C] p-3 rounded-xl text-center print-border print-bg-light">
              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">Circadian Sleep</span>
            ...
            {/* Stress Resilience */}
            <div className="bg-[#050507]/65 border border-[#16161C] p-3 rounded-xl text-center print-border print-bg-light">
              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">Stress Resilience</span>
            ...
            {/* Activity Index */}
            <div className="bg-[#050507]/65 border border-[#16161C] p-3 rounded-xl text-center print-border print-bg-light">
              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">Activity Index</span>
            ...
            <div className="bg-[#050507]/65 border border-[#16161C] p-3 rounded-xl text-center print-border print-bg-light">
              <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">Mental Focus</span>
        ...
        <div className="space-y-3">
          <h3 className="text-xs font-black text-[#A1A1AA] uppercase tracking-widest flex items-center gap-1.5">
            <Activity className="h-4 w-4 text-emerald-500" /> Laboratory Biomarkers & Core Vitals
          </h3>
          <div className="bg-[#040405] border border-[#14141A] rounded-xl overflow-hidden print-border">
            <div className="grid grid-cols-5 bg-[#0C0B0E] p-3 text-[10px] uppercase font-black text-slate-500 tracking-wider font-mono border-b border-[#14141A] print-bg-light print-border print-text-dark">
              <div className="col-span-2">Biomarker / Vital Index</div>
              <div className="text-center">Recorded Value</div>
              <div className="text-center">Reference limits</div>
              <div className="text-right">Evaluation Status</div>
            </div>
            ...
            <div className="divide-y divide-[#121217] text-xs font-medium print-text-dark">
              ...
              <div className="grid grid-cols-5 p-3 items-center hover:bg-[#08080C]/40 transition-all">
                <div className="col-span-2">
                  <span className="font-extrabold text-[#E4E4E7] block print-text-dark">Fasting Blood Sugar</span>
                  <span className="text-[9px] text-[#71717A] leading-none">Measures glycemic regulation and insulin load response.</span>
                </div>
                <div className="text-center font-bold font-mono text-white print-text-dark">{basicInfo.bloodSugar || 100} mg/dL</div>
                <div className="text-center font-mono text-slate-500">70 - 100 mg/dL</div>
              ...
              <div className="grid grid-cols-5 p-3 items-center hover:bg-[#08080C]/40 transition-all">
                <div className="col-span-2">
                  <span className="font-extrabold text-[#E4E4E7] block print-text-dark">Blood Pressure (Systolic / Diastolic)</span>
                  <span className="text-[9px] text-[#71717A] leading-none">Vascular tension and arterial resistance markers.</span>
                </div>
                <div className="text-center font-bold font-mono text-white print-text-dark">{basicInfo.systolicBP || 120}/{basicInfo.diastolicBP || 80} mmHg</div>
                <div className="text-center font-mono text-slate-500">90/60 - 120/80 mmHg</div>
                <div className="text-right">
                  <span className={`text-[9px] font-bold px-2 py-0.5 rounded uppercase ${
              ...
              <div className="grid grid-cols-5 p-3 items-center hover:bg-[#08080C]/40 transition-all">
                <div className="col-span-2">
                  <span className="font-extrabold text-[#E4E4E7] block print-text-dark">Total Serum Cholesterol</span>
                  <span className="text-[9px] text-[#71717A] leading-none">Coronary fat loading risk metric.</span>
                </div>
                <div className="text-center font-bold font-mono text-white print-text-dark">{basicInfo.cholesterolTotal || 190} mg/dL</div>
                <div className="text-center font-mono text-slate-500">130 - 200 mg/dL</div>
                <div className="text-right">
                  <span className={`text-[9px] font-bold px-2 py-0.5 rounded uppercase ${
              ...
              <div className="grid grid-cols-5 p-3 items-center hover:bg-[#08080C]/40 transition-all">
                <div className="col-span-2">
                  <span className="font-extrabold text-[#E4E4E7] block print-text-dark">Resting Heart Rate</span>
                  <span className="text-[9px] text-[#71717A] leading-none">Autonomic cardiac regulation index.</span>
                </div>
                <div className="text-center font-bold font-mono text-white print-text-dark">{basicInfo.heartRate || 72} bpm</div>
                <div className="text-center font-mono text-slate-500">60 - 100 bpm</div>
                <div className="text-right">
                  <span className="text-[9px] font-bold px-2 py-0.5 rounded uppercase bg-emerald-500/10 text-emerald-400 border border-emerald-500/15">
                    Optimal
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-5 p-3 items-center hover:bg-[#08080C]/40 transition-all">
                <div className="col-span-2">
                  <span className="font-extrabold text-[#E4E4E7] block print-text-dark">circadian Sleep Rest Duration</span>
                  <span className="text-[9px] text-[#71717A] leading-none">Sleep depth and REM restoration period.</span>
                </div>
                <div className="text-center font-bold font-mono text-white print-text-dark">{sleepDuration} hrs/day</div>
                <div className="text-center font-mono text-slate-500">7.0 - 9.0 hrs</div>
                <div className="text-right">
                  <span className={`text-[9px] font-bold px-2 py-0.5 rounded uppercase ${
                    sleepDuration < 6.5
                      ? "bg-amber-500/10 text-amber-500 border border-amber-500/15" 
        ...
        <div className="bg-[#070709] border border-[#14141A] rounded-xl p-5 space-y-3 relative overflow-hidden print-border">
          ...
          <div className="flex items-center gap-2 border-b border-[#141419] pb-3 print-border">
            ...
            <div>
              <h3 className="text-xs font-black uppercase text-white tracking-widest print-text-dark">AI Overall Clinical summary</h3>
              <p className="text-[9px] text-slate-500 print-text-muted">Cognitive AI medical twin synthesis & weekly behavioral trends analysis.</p>
            </div>
          </div>
          ...
          {loadingAI ? (
            <div className="py-8 flex flex-col items-center justify-center text-xs text-slate-500 space-y-2">
              ...
              <span>Analyzing biomarkers, mental scores, and predicting health summary trajectories...</span>
            </div>
          ) : (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-[#050507] border border-[#121217] rounded-xl p-4.5 space-y-3 print-border">
            <h4 className="text-[10px] font-black tracking-widest text-[#A1A1AA] uppercase flex items-center gap-1.5 pb-2 border-b border-[#141419] print-border print-text-dark">
              <span className="h-1.5 w-1.5 bg-amber-500 rounded-full" /> Nutrition Gating Suggestions
            </h4>
            
            <div className="space-y-3 text-xs">
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-emerald-400 uppercase tracking-wider block">Recommended Foods:</span>
              ...
              <div className="space-y-1">
                <span className="text-[9px] font-bold text-amber-400 uppercase tracking-wider block">Restrict / Avoid:</span>
                <div className="flex flex-wrap gap-1">
          ...
          <div className="bg-[#050507] border border-[#121217] rounded-xl p-4.5 space-y-3 print-border">
            <h4 className="text-[10px] font-black tracking-widest text-[#A1A1AA] uppercase flex items-center gap-1.5 pb-2 border-b border-[#141419] print-border print-text-dark">
              <span className="h-1.5 w-1.5 bg-purple-500 rounded-full" /> Recovery & Fitness Recommendations
            </h4>
            
            <ul className="text-xs text-slate-300 space-y-2 font-medium print-text-dark">
              <li className="flex gap-2 items-start">
                <span className="text-emerald-400 font-bold shrink-0">✓</span>
                <span>Fitness Target: Walk {steps >= 8000 ? `${steps} steps matched!` : `8,000 daily steps to regulate blood sugar`} & train for 150 minutes weekly.</span>
              </li>
              <li className="flex gap-2 items-start">
                <span className="text-emerald-400 font-bold shrink-0">✓</span>
                <span>Sleep Optimization: Secure consecutive 7.5 to 8 hours rest. Gate all monitors 1 hour prior to biological sleep time.</span>
              </li>
              <li className="flex gap-2 items-start">
                <span className="text-purple-400 font-bold shrink-0">✓</span>
                <span>Parasympathetic Reset: Perform 4-7-8 diaphragmatic deep breathing twice daily (inhale 4s, hold 7s, exhale 8s) to cool anxiety spikes.</span>
              </li>
            </ul>
          </div>
        </div>
