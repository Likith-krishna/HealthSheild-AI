    ...
    <div id="preventive-roadmap" className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="md:col-span-2 bg-[#0F0F0F] border border-[#1A1A1A] rounded-2xl p-6 shadow-xl shadow-black/40 space-y-5">
        <div>
          <h2 className="text-base font-semibold text-white flex items-center gap-1.5">
            <Dumbbell className="h-4 w-5 text-emerald-400" />{t("auto.active_clinical_prevention_milestones", "Active Clinical Prevention Milestones")}

          </h2>
          <p className="text-xs text-slate-500 mt-0.5 font-sans">{t("auto.check_off_daily_cellular_and_cardiovascu", "Check off daily cellular and cardiovascular targets outlined by your medical twin report.")}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#0F0F0F] border border-[#1A1A1A] rounded-2xl p-5 shadow-xl shadow-black/40 space-y-4">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">{t("auto.pre_emptive_biomarker_goals", "Pre-emptive Biomarker Goals")}</h3>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div id="target-calories" className="p-3 bg-rose-500/5 border border-rose-500/10 rounded-xl relative overflow-hidden">
              ...
              <span className="text-[9px] text-rose-450 font-extrabold uppercase">{t("auto.calorie_goal", "Calorie Goal")}</span>
              <div className="text-lg font-extrabold text-white font-mono mt-0.5">{roadmap.dailyCalorieTarget}</div>
              <span className="text-[9px] text-slate-500 block mt-0.5 font-mono">{t("auto.kcal_daily", "kcal / daily")}</span>
            </div>
            ...
            <div id="target-hydration" className="p-3 bg-sky-500/5 border border-sky-500/10 rounded-xl relative overflow-hidden">
              ...
              <span className="text-[9px] text-sky-400 font-extrabold uppercase">{t("auto.water_target", "Water target")}</span>
              <div className="text-lg font-extrabold text-white font-mono mt-0.5">{roadmap.dailyHydrationTarget}</div>
              <span className="text-[9px] text-slate-500 block mt-0.5 font-mono">{t("auto.ml_daily", "ml / daily")}</span>
            </div>
          </div>
          ...
          <div className="bg-[#050505] border border-[#1A1A1A] rounded-xl p-3 space-y-2.5">
            <div className="flex justify-between items-center text-[10px]">
              <span className="text-slate-400 font-bold uppercase">{t("auto.fluid_compliance", "Fluid Compliance:")}{currentWaterLog}{t("auto.ml", "ml")}</span>
            ...
            <div className="flex justify-between gap-2.5">
              <button
                ...
                className="flex-1 bg-[#101010] hover:bg-[#181818] border border-[#222] text-[10px] py-1.5 rounded-md font-bold text-slate-300 hover:text-white cursor-pointer transition-colors">{t("auto.250ml_glass", "+250ml Glass")}
              ...
              <button
                ...
                className="flex-1 bg-[#101010] hover:bg-[#181818] border border-[#222] text-[10px] py-1.5 rounded-md font-bold text-slate-300 hover:text-white cursor-pointer transition-colors">{t("auto.500ml_bottle", "+500ml Bottle")}
        ...
        <div className="bg-[#0F0F0F] border border-[#1A1A1A] rounded-2xl p-5 shadow-xl shadow-black/40 space-y-4">
          <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1 font-mono">
            <Carrot className="h-4 w-4 text-emerald-400" />{t("auto.nutritional_guidelines", "Nutritional Guidelines")}
          ...
          <div className="space-y-3.5">
            ...
            <div className="space-y-1.5">
              <span className="text-[10px] font-bold text-emerald-400 flex items-center gap-1 uppercase">
                <span className="h-1.5 w-1.5 bg-emerald-500 rounded-full" />{t("auto.cardiac_insulin_sensitizing_inclusions", "Cardiac & Insulin Sensitizing Inclusions:")}
            ...
            <div className="space-y-1.5">
              <span className="text-[10px] font-bold text-red-400 flex items-center gap-1 uppercase">
                <AlertTriangle className="h-3 w-3 text-red-500 animate-pulse" />{t("auto.vulnerable_pathological_exclusions", "Vulnerable Pathological Exclusions:")}
